...
contract ERC20{
    ...
    function transfer(address to, uint256 amount) public checkBalance(amount) returns (bool) { //address from을 추가하게되면 from 주소에 다른 사람의 주소를 쓸 수 있게 됨. 공격 취약점 발생. 변조할 수 없는 msg.sender를 사용해야함.
